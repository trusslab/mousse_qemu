...
/* To support undefined ldab instruction, together with the patch in disas_arm_insn */
...
/* patch from https://git.greensocs.com/qemu/cexe/commit/901ad5259fab785537f8c6b3713fce85d2ebceb1 */
...
/* patch from https://git.greensocs.com/qemu/cexe/commit/901ad5259fab785537f8c6b3713fce85d2ebceb1 */
                        ...
                        {
				            assert(0 && "NEON_2RM_VRINTZ failed\n");
                            break;
                        }
                        case NEON_2RM_VRINTX:
                        {
            				assert(0 && "NEON_2RM_VRINTX failed\n");
                            break;
                        }
                        ...
                        {
				            assert(0 && "NEON_2RM_VCVTMS failed\n");
                            break;
                        }
...
/* A patch from https://ipads.se.sjtu.edu.cn:1312/qiuzhe/qemu-official/commit/2359bf80c1c4e8ed1e7ddb03661fec6bace82a87 */
			int op2 = (insn >> 8) & 3;
                        op1 = (insn >> 21) & 0x3;
/* A patch from https://ipads.se.sjtu.edu.cn:1312/qiuzhe/qemu-official/commit/2359bf80c1c4e8ed1e7ddb03661fec6bace82a87 */
			switch (op2) {

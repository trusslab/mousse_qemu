...
/* Changed according to s2e, keep it consistent */
...
enum arm_features {
    ...
    ARM_FEATURE_V8, /* Yingtong, to fix undefined ldab instruction */
}; 

static inline int arm_feature(CPUARMState *env, int feature)
{
	if(feature == ARM_FEATURE_V8) {
		fprintf(stderr, "%s: query ARM_FEATURE_V8\n",__FUNCTION__);
	}
